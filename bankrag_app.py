...
# =========================================================
# LOAD BANKRAG PRODUCTION MODELS
# =========================================================
...
if analyze_button:
    ...
    st.caption(
        "Policy evidence retrieved from the BankRAG "
    ...
    report_prompt = f"""
You are BankRAG, an explainable AI credit-risk decision-support system.
...
"""
    ...
    st.header("🤖 BankRAG Credit Risk Report")
